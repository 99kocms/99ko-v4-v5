...
<div class="fb-like" data-href="https://www.facebook.com/99kocms/" data-layout="button_count" data-action="like" data-size="small" data-show-faces="false" data-share="false"></div>
				</li>
			  </ul>
			</div>
		</div>
		<div id="body">
		  <div id="content_mask">
			...
			<p class="just_using">
			  <a target="_blank" href="http://janisjoplin.fr/page/99ko-cms,28.html">Just using 99ko <?php echo VERSION; ?></a>
			</p>
		  </div>
